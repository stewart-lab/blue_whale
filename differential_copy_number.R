...
# Parameters
WORK_DIR <- "/Volumes/home/Projects/BWGENOME/final_stage_analyses/Gene_lists/2_differential_copy_number/Version_3"
...
fold_change <- (segdups$BlueWhale)/(segdups$Vaquita)
...
diff_dup_genes_of_interest <- merge(diffdups, genes_of_interest, by.x = "Gene", by.y = "gene")
